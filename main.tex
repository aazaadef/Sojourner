...
We deployed a self-hosted instance for 22 master's students and collected pre/post MCQ assessments (11~items), self-confidence Likert scales, post-session perception questionnaires, open-ended feedback, and in-game behavioral telemetry (3,161 events across 14 event types).
...
Telemetry further corroborated these findings: game progression correlated significantly with MCQ gains (Spearman $\rho = 0.549$, $p = 0.006$), confirming that deeper engagement produces greater learning.
